...
- [x] Implementar alocador de memória `*mm_alloc(size_t count, size_t size)`
- [x] Implementar liberador de memória `void mm_garbage_collector()`
...
### ⚡ Otimizações Matemáticas (Opcional)
...
### 📝 Parser de Elementos de Configuração
...
### 🎨 Gradientes de Profundidade (Bonus)
